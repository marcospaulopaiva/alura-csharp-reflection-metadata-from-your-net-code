    ...
    internal class ActionBinder
    {
        public ActionBindInfo ObterActionBindInfo(object controller, string path)
        {
            ...
            else
            {
                ...
                var methodInfo = ObterMethodInforAPartirDeNomeEArgumentos(nomeAction, nomeArgumentos, controller);
        ...
        private MethodInfo ObterMethodInforAPartirDeNomeEArgumentos(string nomeAction, string[] argumentos, object controller)
        {
